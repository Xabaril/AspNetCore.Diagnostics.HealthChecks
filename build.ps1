...
if ($suffix -eq "") {
    ...
    exec { & dotnet pack .\src\HealthChecks.Neo4j\HealthChecks.Neo4j.csproj -c Release -o .\artifacts --include-symbols --no-build }
    ...
    exec { & dotnet pack .\src\HealthChecks.UI.Core\HealthChecks.UI.Core.csproj -c Release -o .\artifacts --include-symbols --no-build }
    ...
    exec { & dotnet pack .\src\HealthChecks.UI.PostgreSQL.Storage\HealthChecks.UI.PostgreSQL.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build }
    exec { & dotnet pack .\src\HealthChecks.UI.MySql.Storage\HealthChecks.UI.MySql.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build }
    exec { & dotnet pack .\src\HealthChecks.UI.InMemory.Storage\HealthChecks.UI.InMemory.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build }
    ...
    exec { & dotnet pack .\src\HealthChecks.Prometheus.Metrics\HealthChecks.Prometheus.Metrics.csproj -c Release -o .\artifacts --include-symbols --no-build }
    ...
    exec { & dotnet pack .\src\HealthChecks.Neo4j\HealthChecks.Neo4j.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    ...
    exec { & dotnet pack .\src\HealthChecks.UI.Core\HealthChecks.UI.Core.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    ...
    exec { & dotnet pack .\src\HealthChecks.UI.PostgreSQL.Storage\HealthChecks.UI.PostgreSQL.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    exec { & dotnet pack .\src\HealthChecks.UI.MySql.Storage\HealthChecks.UI.MySql.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    exec { & dotnet pack .\src\HealthChecks.UI.InMemory.Storage\HealthChecks.UI.InMemory.Storage.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    ...
    exec { & dotnet pack .\src\HealthChecks.Publisher.Datadog\HealthChecks.Publisher.Datadog.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
    exec { & dotnet pack .\src\HealthChecks.Prometheus.Metrics\HealthChecks.Prometheus.Metrics.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
