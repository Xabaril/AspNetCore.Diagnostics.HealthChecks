...
if ($suffix -eq "") {
    ...
    exec { & dotnet pack .\src\HealthChecks.IdentityServer\HealthChecks.IdentityServer.csproj -c Release -o .\artifacts --include-symbols --no-build }
    ...
    exec { & dotnet pack .\src\HealthChecks.IdentityServer\HealthChecks.IdentityServer.csproj -c Release -o .\artifacts --include-symbols --no-build --version-suffix=$suffix }
