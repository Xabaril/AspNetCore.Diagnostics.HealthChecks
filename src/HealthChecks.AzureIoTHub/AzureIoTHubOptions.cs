...
namespace HealthChecks.AzureIoTHub
{
    public class AzureIoTHubOptions
    {
        ...
        internal bool RegistryReadCheck { get; private set; } = false;
        internal bool RegistryWriteCheck { get; private set; } = false;
        internal bool ServiceConnectionCheck { get; private set; } = false;
        ...
        public AzureIoTHubOptions AddRegistryWriteCheck(Func<string> deviceIdFactory = null)
        {
            ...
            RegistryWriteDeviceIdFactory = deviceIdFactory ?? (() => $"health-check-registry-write-{Guid.NewGuid()}");
            return this;
        }
