...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AzureServiceBusHealthCheckBuilderExtensions
    {
        ...
        /// <param name="eventHubName">The azure event hub name.. Required when connection string  is scoped to the whole namespace</param>
        ...
        public static IHealthChecksBuilder AddAzureEventHub(this IHealthChecksBuilder builder, string connectionString, string eventHubName = null, string name = default, HealthStatus? failureStatus = default, IEnumerable<string> tags = default, TimeSpan? timeout = default)
        {
        ...
        /// <param name="queueName">The name of the queue to check. Required when connection string  is scoped to the whole namespace</param>
        ...
        /// <returns>The <see cref="IHealthChecksBuilder"/>.</returns>
        public static IHealthChecksBuilder AddAzureServiceBusQueue(this IHealthChecksBuilder builder, string connectionString, string queueName = null, string name = default, HealthStatus? failureStatus = default, IEnumerable<string> tags = default, Action<Message> configuringMessage = null, TimeSpan? timeout = default, bool requiresSession = false)
        {
            return builder.Add(new HealthCheckRegistration(
                ...
                sp =>
                {
                    return string.IsNullOrWhiteSpace(queueName)
                        ? new AzureServiceBusQueueHealthCheck(connectionString, configuringMessage, requiresSession)
                        : new AzureServiceBusQueueHealthCheck(connectionString, queueName, configuringMessage, requiresSession);
                },
                failureStatus,
                tags,
                timeout));
        ...
        /// <param name="topicName">The topic name of the topic to check. Required when connection string  is scoped to the whole namespace</param>
        ...
        /// <param name="requiresSession">An optional boolean flag that indicates whether session is enabled on the queue or not. Defaults to false.</param>
        /// <returns>The <see cref="IHealthChecksBuilder"/>.</returns>
        public static IHealthChecksBuilder AddAzureServiceBusTopic(this IHealthChecksBuilder builder, string connectionString, string topicName = null, string name = default, HealthStatus? failureStatus = default, IEnumerable<string> tags = default, Action<Message> configuringMessage = null, TimeSpan? timeout = default, bool requiresSession = false)
        {
            return builder.Add(new HealthCheckRegistration(
                ...
                sp =>
                {
                    return string.IsNullOrWhiteSpace(topicName)
                        ? new AzureServiceBusTopicHealthCheck(connectionString, configuringMessage, requiresSession)
                        : new AzureServiceBusTopicHealthCheck(connectionString, topicName, configuringMessage, requiresSession);
                },
                failureStatus,
                tags,
                timeout));
