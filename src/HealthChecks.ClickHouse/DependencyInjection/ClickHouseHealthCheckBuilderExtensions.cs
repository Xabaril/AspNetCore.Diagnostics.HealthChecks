...
public static class ClickHouseHealthCheckBuilderExtensions
{
    ...
    public static IHealthChecksBuilder AddClickHouse(
        ...
        Action<ClickHouseConnection>? connectionAction = null,
        string? name = default,
        HealthStatus? failureStatus = default,
        IEnumerable<string>? tags = default,
        TimeSpan? timeout = default)
    {
        return builder.AddClickHouse(_ => clickHouseConnectionString, healthQuery, connectionAction, name, failureStatus, tags, timeout);
    }
        ...
        TimeSpan? timeout = default)
    {
        ...
        builder.Services.AddSingleton(sp => new ClickHouseHealthCheck(connectionStringFactory(sp), healthQuery, connectionAction));
