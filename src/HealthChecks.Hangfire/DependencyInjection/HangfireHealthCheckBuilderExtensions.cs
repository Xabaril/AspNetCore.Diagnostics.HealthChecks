...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class HangfireHealthCheckBuilderExtensions
    {
        ...
        public static IHealthChecksBuilder AddHangfire(this IHealthChecksBuilder builder, Action<HangfireOptions> setup = null, string name = default, HealthStatus? failureStatus = default, IEnumerable<string> tags = default)
        {
