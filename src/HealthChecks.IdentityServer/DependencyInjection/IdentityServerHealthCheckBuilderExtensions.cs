using HealthChecks.IdentityServer;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        const string NAME = "identityserver";
        /// <summary>
        /// Add a health check for Identity Server.
        /// </summary>
        /// <param name="builder">The <see cref="IHealthChecksBuilder"/>.</param>
        /// <param name="idSvrUri">The uri of the Identity Server to check.</param>
        /// <param name="name">The health check name. Optional. If <c>null</c> the type name 'identityserver' will be used for the name.</param>
        ...
        public static IHealthChecksBuilder AddIdentityServer(this IHealthChecksBuilder builder, Uri idSvrUri, string name = default, HealthStatus? failureStatus = default, IEnumerable<string> tags = default,TimeSpan? timeout = default)
        {
            ...
            return builder.Add(new HealthCheckRegistration(
                registrationName,
                sp => new IdentityServerHealthCheck(() => sp.GetRequiredService<IHttpClientFactory>().CreateClient(registrationName)),
                failureStatus,
                tags,
                timeout));
        }
