...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static HealthChecksUIBuilder AddSqliteStorage(this HealthChecksUIBuilder builder, string connectionString, Action<HealthCheckDbOptions> healthchecksContextOptions = null, Action<DbContextOptionsBuilder> configureOptions = null)
        {
