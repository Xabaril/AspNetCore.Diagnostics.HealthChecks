...
namespace Microsoft.AspNetCore.Builder
{
    public static class EndpointRouteBuilderExtensions
    {
            ...
            Action<Options> setupOptions = null)
        {
            ...
            var settings = builder.ServiceProvider.GetService<IOptions<Settings>>().Value;
            if (settings.OidcOptions != null)
            {
                apiEndpoint.RequireAuthorization(settings.OidcOptions.BackendAuthorizationPolicy ?? null);
                webhooksEndpoint.RequireAuthorization(settings.OidcOptions.BackendAuthorizationPolicy ?? null);
            }
