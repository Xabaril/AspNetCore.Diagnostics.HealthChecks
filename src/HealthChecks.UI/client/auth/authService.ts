...
export class AuthService {
    ...
    public signInRedirectCallback() {
        this.userManager.signinRedirectCallback("/healthecks-ui#/healthchecks");
    }
    ...
    private bindEvents() {
        ...
        this.userManager.events.addAccessTokenExpired(e => console.log('The access token expired'));
        this.userManager.events.addSilentRenewError(e => console.log('There was an error in the silent renew process', e));
