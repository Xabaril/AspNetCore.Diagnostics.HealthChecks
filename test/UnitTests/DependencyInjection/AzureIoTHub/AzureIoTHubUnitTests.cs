    ...
    public class azure_iothub_registration_should
    {
        ...
        public void add_health_check_when_properly_configured()
        {
            ...
            services.AddHealthChecks()
                .AddAzureIoTHub(setup => "https://iothub");
        ...
        public void add_named_health_check_when_properly_configured()
        {
            var services = new ServiceCollection();
            services.AddHealthChecks()
                .AddAzureIoTHub(setup => "https://iothub", name: "iothubcheck");
        ...
        public void fail_when_invalid_connection_string_provided_in_configuration()
        {
            ...
            {
                services.AddHealthChecks()
                    .AddAzureIoTHub((Func<IServiceProvider, string>)null);
            });
        }

        [Fact]
        public void fail_when_invalid_connection_string_in_configuration()
        {
            var services = new ServiceCollection();
